...
| AC-6 | The engine correctly slices an AST with multiple sections, including edge cases like empty sections or single-section documents. | Unit      | Jest           | Create mock ASTs to test various structural layouts. |
