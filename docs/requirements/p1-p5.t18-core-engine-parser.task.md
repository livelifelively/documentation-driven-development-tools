...
- [x] **IMPLEMENTATION COMPLETED** - All modules implemented and all 35 tests passing.
...
| AC-6 | The engine correctly slices an AST with multiple sections, including edge cases like empty sections or single-section documents. | Unit      | Vitest         | Create mock ASTs to test various structural layouts. |
