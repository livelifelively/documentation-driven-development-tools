...
| :-- | :---------------------------------------------------------------------- | :------- | :------------------------------- | :---------- | :--------- | :----------------------------------------------------------------- |
| t18 | [Core Engine & Markdown Parser](./p1.p5.t18-core-engine-parser.task.md) | 🟥 High  | TEC-Dev_Productivity_Enhancement | ✅ Complete | —          | Event-driven core engine, AST, section extraction, event emission. |
