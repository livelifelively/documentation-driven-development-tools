...
| :-------------------- | :---------------------------------------------------------------- | :-------------------- | :--------------------------------------------------------------------- |
| **Unit Tests**        | `GitService`, `TaskService`, and commit message validation logic. | Jest                  | Mock `simple-git` and `fs` to isolate logic.                           |
| **Integration Tests** | `ddd start` and `ddd commit` commands.                            | Jest, `child_process` | Run CLI commands against a temporary, dummy Git repository.            |
