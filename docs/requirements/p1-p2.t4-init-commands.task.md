...
| AC-8 | `ddd init --debug` outputs verbose file operation logs to the console. | Unit        | Jest + console capture | Verify that debug-level logs are present. |
